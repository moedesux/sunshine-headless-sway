...
SWAY_SUNSHINE_DIR = Path("~/.config/sway-sunshine").expanduser()
...
def _state_paths() -> Dict[str, str]:
    ...
    return {
        ...
        "set_resolution_script": str(SWAY_SUNSHINE_DIR / "set-resolution.sh"),
        "reset_resolution_script": str(SWAY_SUNSHINE_DIR / "reset-resolution.sh"),

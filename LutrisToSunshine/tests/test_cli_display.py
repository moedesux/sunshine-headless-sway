    ...
    def test_handle_display_status_renders_plain_dashboard_without_ansi(self) -> None:
        ...
        try:
            lutristosunshine.display_snapshot = lambda: {
                ...
                "host_session": "Hyprland",
                "input_isolation_mode": "hyprctl-runtime-disable",
                ...
                "input_isolation_error": "",
                "input_isolation_state": "inactive",
                "input_isolation_devices": [],
                "input_isolation_seen_device_count": 0,
                "sunshine_input_device_count": 0,
                "input_isolation_failed_devices": [],
                "controller_detection_error": None,
                "controller_count": 1,
                "controllers": [
                    {
